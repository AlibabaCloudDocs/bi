...
2.  输入所需要的数据源连接信息，如下图所示：
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/23954/153985144913878_zh-CN.png)
...
2.  输入所需要的数据源连接信息，如下图所示：
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/23954/153985144913887_zh-CN.png)
...
2.  输入所需要的数据源连接信息，如下图所示：
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/23954/153985144913888_zh-CN.png)
...
2.  输入所需要的数据源连接信息，如下图所示：
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/23954/153985145013889_zh-CN.png)
...
2.  输入所需要的数据源连接信息，如下图所示：
    ...
    **说明：** 如果该数据源为vpc连接，请勾选vpc数据源选项并输入相关参数。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/23954/153985145013890_zh-CN.png)
...
2.  输入所需要的数据源连接信息，如下图所示：
    ...
    **说明：** 如果该数据源为vpc连接，请勾选vpc数据源选项并输入相关参数。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/23954/153985145013891_zh-CN.png)
...
2.  输入所需要的数据源连接信息，如下图所示：
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/23954/153985145013892_zh-CN.png)
...
2.  输入所需要的数据源连接信息，如下图所示：
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/23954/153985145013893_zh-CN.png)
...
2.  输入所需要的数据源连接信息，如下图所示：
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/23954/153985145013894_zh-CN.png)
...
3.  如果您需要对Hive数据源加速，输入以下数据源加速信息，如下图所示：
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/9084/15398514501303_zh-CN.png)
...
2.  输入所需要的数据源连接信息，如下图所示：
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/23954/153985145013895_zh-CN.png)
