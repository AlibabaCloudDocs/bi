...
3.   输入所需要的数据源连接信息，如下图所示。 
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/9084/15396945071292_zh-CN.png)
...
2.   输入所需要的数据源连接信息，如下图所示。 
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/9084/15396945071294_zh-CN.png)
...
2.   输入所需要的数据源连接信息，如下图所示。 
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/9084/15396945071296_zh-CN.png)
...
2.   输入所需要的数据源连接信息，如下图所示。 
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/9084/15396945071297_zh-CN.png)
...
2.  输入所需要的数据源连接信息，如下图所示。 
    ...
    **说明：** 如果该数据源为vpc连接，请勾选vpc数据源选项并输入相关参数。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/9084/153969450712903_zh-CN.png)
...
2.   输入所需要的数据源连接信息，如下图所示。 
    ...
    **说明：** 如果该数据源为vpc连接，请勾选vpc数据源选项并输入相关参数。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/9084/153969450713720_zh-CN.png)
...
2.   输入所需要的数据源连接信息，如下图所示。 
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/9084/15396945081300_zh-CN.png)
...
2.   输入所需要的数据源连接信息，如下图所示。 
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/9084/15396945081301_zh-CN.png)
...
2.  输入所需要的数据源连接信息，如下图所示。 
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/9084/15396945081302_zh-CN.png)
...
3.  如果您需要对Hive数据源加速，输入以下数据源加速信息，如下图所示。 
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/9084/15396945081303_zh-CN.png)
...
## Data Lake Analytics（Quick BI专业版和高级版） {#task_ant_r3f_1fb}
...
2.  输入所需要的数据源连接信息，如下图所示。 
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/9084/153969450811184_zh-CN.png)
