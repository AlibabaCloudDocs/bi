...
2.  输入所需要的数据源连接信息，如下图所示：
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/23954/156741594013878_zh-CN.png)
...
2.  输入所需要的数据源连接信息，如下图所示：
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/23954/156741594013887_zh-CN.png)
...
2.  输入所需要的数据源连接信息，如下图所示：
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/23954/156741594013888_zh-CN.png)
...
2.  输入所需要的数据源连接信息，如下图所示：
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/23954/156741594057049_zh-CN.png)
...
2.  输入所需要的数据源连接信息，如下图所示：
    ...
    **说明：** 如果该数据源为vpc连接，请勾选vpc数据源选项并输入相关参数。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/23954/156741594013890_zh-CN.png)
...
2.  输入所需要的数据源连接信息，如下图所示：
    ...
    **说明：** 如果该数据源为vpc连接，请勾选vpc数据源选项并输入相关参数。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/23954/156741594013891_zh-CN.png)
...
2.  输入所需要的数据源连接信息，如下图所示：
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/23954/156741594013892_zh-CN.png)
...
2.  输入所需要的数据源连接信息，如下图所示：
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/23954/156741594013893_zh-CN.png)
...
2.  输入所需要的数据源连接信息，如下图所示：
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/23954/156741594013894_zh-CN.png)
...
2.  输入所需要的数据源连接信息，如下图所示：
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/23954/156741594013895_zh-CN.png)
...
2.  输入所需要的数据源连接信息，如下图所示：
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/23954/156741594031892_zh-CN.png)
...
2.  输入所需要的数据源连接信息，如下图所示：
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/23954/156741594131893_zh-CN.png)
...
2.  输入所需要的数据源连接信息，如下图所示：
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/23954/156741594149524_zh-CN.png)
...
2.  输入所需要的数据源连接信息，如下图所示：
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/23954/156741594149526_zh-CN.png)
...
2.  输入所需要的数据源连接信息，如下图所示：
    ...
    **说明：** 如果该数据源为vpc连接，请勾选vpc数据源选项并输入相关参数。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/23954/156741594152319_zh-CN.png)
