...
4.  选择UTF-8编码，如下图所示。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/9086/15435705521311_zh-CN.png)
...
5.  单击**选择文件**，从本地上传，如下图所示。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/9086/154357055233512_zh-CN.png)
...
3.  单击**选择文件**，从本地上传，如下图所示。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/9086/154357055233511_zh-CN.png)
...
4.  单击**追加**，上传需要追加的文件，如下图所示：
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/9086/154357055233506_zh-CN.png)
...
4.  确认需要删除的文件，单击后面的**删除**，如下图所示：
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/9086/154357055233504_zh-CN.png)
